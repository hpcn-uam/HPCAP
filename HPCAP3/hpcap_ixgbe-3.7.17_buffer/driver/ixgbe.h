...
#define DEV_HPCAP //comment to stop using PacketShader
#ifdef DEV_HPCAP
...
#ifdef DEV_HPCAP
	#define IXGBE_FLAG_RX_KERNEL_ENABLE		(u32)(1 << 12)
#endif /* DEV_HPCAP */
...
#define ixgbe_get_netdev_tc_txq(dev, tc) (&dev->tc_to_txq[tc]);
	...
	extern void ixgbe_irq_disable_queues(struct ixgbe_adapter *, u64);
	extern void ixgbe_irq_enable_queues(struct ixgbe_adapter *, u64);
	extern void ixgbe_release_rx_desc(struct ixgbe_ring *, u32);
	extern bool ixgbe_clean_tx_irq(struct ixgbe_q_vector *, struct ixgbe_ring *);
#endif /* DEV_HPCAP */
